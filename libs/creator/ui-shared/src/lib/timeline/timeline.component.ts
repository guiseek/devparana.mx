...
export class TimelineComponent implements AfterViewInit {
  ...
  gIsMousedown: boolean = false

  // marker of drag the mouse move
  gIsMousemove: boolean = false
  ...
  canvasExp!: ElementRef<HTMLCanvasElement>
  ...
  mousemoveFunc(e: MouseEvent): void {
    ...
    this.gMousedownCursor = this.gMousedownCursor ? this.gMousedownCursor : 0;
   ...
   */
  mousewheelFunc(event: any): void | boolean {
