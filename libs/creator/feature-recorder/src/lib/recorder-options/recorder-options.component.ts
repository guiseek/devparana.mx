  ...
  options = [
    {
      ...
      description: 'Use gravações de tela para partes técnicas da sua apresentação e evite erros ao vivo',
    ...
    },
    {
      ...
      description: 'Grave conteúdo explicativo, compartilhe conhecimento na comunidade',
